#  -----------------------------------------
#  Módulo 13:  Streptococcus pneumoniae
#  -----------------------------------------
...
#  o DataFrame a partir do arquivo Excel chamado 'endeinstein.xlsx'
...
for i in range(len(df)):
    ...
    if unid != "Referencia" and  unid != "ReferÃªncia1":
       nUnid= nUnid + 1
    ...
    # Inicializa uma variÃ¡vel n com o valor 1
    n = 1
    # Loop para adicionar as coordenadas Ã  lista BaseDados de acordo com o nÃºmero de infectados
    while n <= infectados:
...
# Usa Streamlit para exibir um grÃ¡fico PyDeck na interface
