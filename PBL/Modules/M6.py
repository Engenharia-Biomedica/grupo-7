#  -----------------------------------------
#  Módulo 6:  Plot infecção por hospitais x "Streptococcus pneumoniae"
#  -----------------------------------------
...
for i in range(len(df)):
    ...
    n = 1
    # Loop para adicionar as coordenadas à lista BaseDados de acordo com o número de infectados
    while n <= infectados:
